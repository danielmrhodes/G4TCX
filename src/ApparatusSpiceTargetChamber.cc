...
ApparatusSpiceTargetChamber::ApparatusSpiceTargetChamber(G4String Options, G4bool chk)
{
  //Options parameter chooses which lens is in place.
	BuildMEL=false;
	Empty=false;
	Light=false;
	Bunny=false;
	...
	if(G4StrUtil::contains(Options,"Empty") || G4StrUtil::contains(Options,"EMPTY") ||
	   G4StrUtil::contains(Options,"empty")) {
		Empty=true;
		G4cout<<G4endl<<" Using Empty SPICE Lens Chamber";
	}
	else {
		if(G4StrUtil::contains(Options,"Med") || G4StrUtil::contains(Options,"med") ||
		   G4StrUtil::contains(Options,"MED") ||G4StrUtil::contains(Options,"MEL") ||
		   G4StrUtil::contains(Options,"Medium")||G4StrUtil::contains(Options,"medium")){
			BuildMEL=true;
		...
		if(G4StrUtil::contains(Options,"Col") || G4StrUtil::contains(Options,"COL") ||
		   G4StrUtil::contains(Options,"col") || G4StrUtil::contains(Options,"collimator") ||
		   G4StrUtil::contains(Options,"Collimator") ||
		   G4StrUtil::contains(Options,"COLLIMATOR")) {
			Col=true;
	...
	if(G4StrUtil::contains(Options,"Light") || G4StrUtil::contains(Options,"LIGHT") ||
	   G4StrUtil::contains(Options,"light") || G4StrUtil::contains(Options,"lite") ||
	   G4StrUtil::contains(Options,"LITE")||G4StrUtil::contains(Options,"Lite")){
		Light=true;
		G4cout<<G4endl<<" Building Only Crucial SPICE Components";
	}

	if(G4StrUtil::contains(Options,"Eff") || G4StrUtil::contains(Options,"EFF") ||
	   G4StrUtil::contains(Options,"eff") || G4StrUtil::contains(Options,"efficiency") ||
	   G4StrUtil::contains(Options,"efficiency")||G4StrUtil::contains(Options,"EFFICIENCY")){
		Eff=true;
		G4cout<<G4endl<<" Building the SPICE On-Wheel Efficiency Source Holder.";
	}
	else if(G4StrUtil::contains(Options,"Source") || G4StrUtil::contains(Options,"source") ||
		G4StrUtil::contains(Options,"SOURCE")){
		Source=true;
		G4cout<<G4endl<<" Building Z=0 NON-Efficiency Source Holder.";
	}
	else if(G4StrUtil::contains(Options,"Bunny") || G4StrUtil::contains(Options,"BUNNY") ||
		G4StrUtil::contains(Options,"bunny") || G4StrUtil::contains(Options,"bun") ||
		G4StrUtil::contains(Options,"Bun")||G4StrUtil::contains(Options,"BUN")){
		Bunny=true;
	...
	G4Material* MatAc = new G4Material("Acrylic",1.19*g/cm3,3);
	MatAc->AddElement(man->FindOrBuildElement("C"),5);
	MatAc->AddElement(man->FindOrBuildElement("H"),8);
	MatAc->AddElement(man->FindOrBuildElement("O"),2);
...
void ApparatusSpiceTargetChamber::BuildBunnyTarget() {
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* sMaterial = man->FindOrBuildMaterial("G4_Al");
...
void ApparatusSpiceTargetChamber::BuildTargetChamberFrontRing()
{
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* frontRingMaterial = man->FindOrBuildMaterial("G4_Al");
...
void ApparatusSpiceTargetChamber::BuildTargetChamberSphere()
{
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* sphereMaterial = man->FindOrBuildMaterial("G4_POLYOXYMETHYLENE");
...
void ApparatusSpiceTargetChamber::BuildTargetChamberCylinderDownstream(bool MEL)
{
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* cylinderMaterial = man->FindOrBuildMaterial("G4_POLYOXYMETHYLENE");
...
void ApparatusSpiceTargetChamber::BuildTargetWheel(){
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* targetWheelMaterial = man->FindOrBuildMaterial("G4_POLYOXYMETHYLENE");
...
void ApparatusSpiceTargetChamber::BuildCollimator() {
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* CollimatorMaterial = man->FindOrBuildMaterial("G4_Ti");
...
void ApparatusSpiceTargetChamber::BuildTargetWheelGears(){
	...
	G4Material* gearMaterialB = man->FindOrBuildMaterial("G4_Al");
	...
	G4Material* gearMaterialA = man->FindOrBuildMaterial("G4_POLYOXYMETHYLENE");
...
void ApparatusSpiceTargetChamber::BuildTargetWheelGearPlates() {
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* gearPlateMaterial = man->FindOrBuildMaterial("G4_Al");
...
void ApparatusSpiceTargetChamber::BuildGearStick(){
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material *gearStickMaterial = new G4Material("gearStickMaterial",1.31*g/cm3,3);
	gearStickMaterial->AddMaterial(man->FindOrBuildMaterial("G4_C"),0.76);
	gearStickMaterial->AddMaterial(man->FindOrBuildMaterial("G4_H"),0.08);
	gearStickMaterial->AddMaterial(man->FindOrBuildMaterial("G4_O"),0.16);
...
void ApparatusSpiceTargetChamber::BuildTargetMountPlate(){
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* targetMountPlateMaterial = man->FindOrBuildMaterial("gearStickMaterial");
...
void ApparatusSpiceTargetChamber::BuildPhotonShield()
{
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material *layerOneMaterial = new G4Material("layerOneMaterial",16.75*g/cm3,2);
	layerOneMaterial->AddElement(man->FindOrBuildElement("W"),0.025);
	layerOneMaterial->AddElement(man->FindOrBuildElement("Ta"),0.975);
	...
	G4Material* layerTwoMaterial = man->FindOrBuildMaterial("G4_Sn");
	...
	G4Material* layerThreeMaterial = man->FindOrBuildMaterial("G4_Cu");
...
void ApparatusSpiceTargetChamber::BuildShieldCovering()
{
	...
	G4NistManager* man = G4NistManager::Instance();	
	G4Material *shieldCoverMaterial = man->FindOrBuildMaterial("G4_KAPTON");
...
void ApparatusSpiceTargetChamber::BuildPhotonShieldClamps() {
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* psClampMaterial = man->FindOrBuildMaterial("G4_Al");
...
void ApparatusSpiceTargetChamber::BuildPhotonShieldClampBolts() {
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* smallBoltMaterial = man->FindOrBuildMaterial("G4_BRASS");
...
void ApparatusSpiceTargetChamber::BuildCollectorMagnetandCover()
{
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material *magnetMaterial = new G4Material("magnetMaterial",7.5*g/cm3,3);
	magnetMaterial->AddElement(man->FindOrBuildElement("Nd"),2);
	magnetMaterial->AddElement(man->FindOrBuildElement("Fe"),14);
	magnetMaterial->AddElement(man->FindOrBuildElement("B"),1);
...
void ApparatusSpiceTargetChamber::BuildMagnetCovering(G4VSolid* Magnet)
{
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material *magnetCoverMaterial = new G4Material("magnetCoverMaterial",1.31*g/cm3,3);
	magnetCoverMaterial->AddMaterial(man->FindOrBuildMaterial("G4_C"),0.76);
	magnetCoverMaterial->AddMaterial(man->FindOrBuildMaterial("G4_H"),0.08);
	magnetCoverMaterial->AddMaterial(man->FindOrBuildMaterial("G4_O"),0.16);
...
void ApparatusSpiceTargetChamber::BuildMagnetClampChamber(){
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material *clampMaterial = new G4Material("clampMaterial",1.31*g/cm3,3);
	clampMaterial->AddMaterial(man->FindOrBuildMaterial("G4_C"),0.76);
	clampMaterial->AddMaterial(man->FindOrBuildMaterial("G4_H"),0.08);
	clampMaterial->AddMaterial(man->FindOrBuildMaterial("G4_O"),0.16);
...
void ApparatusSpiceTargetChamber::BuildElectroBox()
{
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* electroBoxMaterial = man->FindOrBuildMaterial("G4_Al");
...
void ApparatusSpiceTargetChamber::BuildColdFinger()
{
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* coldFingerMaterial = man->FindOrBuildMaterial("G4_Cu");
...
void ApparatusSpiceTargetChamber::BuildS3CableHolder()
{
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* sMaterial = man->FindOrBuildMaterial("G4_POLYOXYMETHYLENE");
...
void ApparatusSpiceTargetChamber::BuildConicalCollimator() {
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* sMaterial = man->FindOrBuildMaterial("layerOneMaterial");
...
void ApparatusSpiceTargetChamber::BuildXrayInsert(){
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* sMaterial = man->FindOrBuildMaterial("G4_Cu");
...
void ApparatusSpiceTargetChamber::BuildPlaceEfficiencySource(G4LogicalVolume* expHallLog){
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* sMaterialT = man->FindOrBuildMaterial("G4_TEFLON");
	...
	new G4PVPlacement(new G4RotationMatrix,G4ThreeVector(0,0,fTargetWheelFaceZ-base/2.), TLog, "SourceHolderEff", expHallLog, false,0,check);
	
	G4Material* sMaterialSR = new G4Material("Brass",8.7*g/cm3,2);
	sMaterialSR->AddElement(man->FindOrBuildElement("Cu"),0.63);
	sMaterialSR->AddElement(man->FindOrBuildElement("Zn"),0.37);
	...
	new G4PVPlacement(new G4RotationMatrix,G4ThreeVector(0,screwradplacement,fTargetWheelFaceZ-fEffSourceHolderHeight-fEffSourceScrewHeight/2.), SScrewLog, "SourceHolderScrew1", expHallLog, false,0,check);
	new G4PVPlacement(new G4RotationMatrix,G4ThreeVector(0,-screwradplacement,fTargetWheelFaceZ-fEffSourceHolderHeight-fEffSourceScrewHeight/2.), SScrewLog, "SourceHolderScrew2", expHallLog, false,0,check);
...
void  ApparatusSpiceTargetChamber::BuildMEezagSource(G4LogicalVolume* expHallLog){
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* sMaterialsf = man->FindOrBuildMaterial("G4_Al");
	...
	new G4PVPlacement(new G4RotationMatrix,G4ThreeVector(0,0,fMEezagSourceZ), SFlog, "SourceFrame", expHallLog, false, 0,check);
	...
	G4Material* sMaterialAc = man->FindOrBuildMaterial("Acrylic");
	...
	new G4PVPlacement(new G4RotationMatrix,G4ThreeVector(0,0,AcrylicZ), Acrlog, "SourceAcrylic", expHallLog, false, 0,check);
...
void  ApparatusSpiceTargetChamber::BuildPlaceSource(G4LogicalVolume* expHallLog){
	...
	G4NistManager* man = G4NistManager::Instance();
	G4Material* material = man->FindOrBuildMaterial("G4_Al");
	...
	new G4PVPlacement(new G4RotationMatrix,moveB,fScrewLog, "bracket_screw", expHallLog,false, 0,check); 
	new G4PVPlacement(new G4RotationMatrix,moveC,fScrewLog, "bracket_screw", expHallLog,false, 0,check); 
...
void ApparatusSpiceTargetChamber::PlaceBunnyTarget(G4int i, G4LogicalVolume* expHallLog) {
	...
	fRodPhysical = new G4PVPlacement(sRotate, TargetOffset+RodOffset, fRodLogical, "BunnyTargetRods", expHallLog, false, 0,check);
...
void ApparatusSpiceTargetChamber::PlaceEvapTarget(G4int i, G4LogicalVolume* expHallLog) {
	...
	fRodPhysical = new G4PVPlacement(sRotate, TargetOffset+RodOffset, fRodLogical, "EvapTargetScrew", expHallLog, false, 0,check);
...
void ApparatusSpiceTargetChamber::PlaceCollimator(G4LogicalVolume* expHallLog) {
	...
	fCollimPhysical = new G4PVPlacement(rotate, move, fCollimLogical, "collimator", expHallLog, false, 0,check);
}
...
void ApparatusSpiceTargetChamber::PlaceTargetMountPlate(G4LogicalVolume* expHallLog) 
{
	...
	for(int i=0;i<7;i++){
		...
		moveR.rotateZ(ang);
		fTargetMountRodPhys = new G4PVPlacement(rotate, moveR, fTargetMountRodLog,"TargetMountRod", expHallLog,false,0,check);
	}
...
void ApparatusSpiceTargetChamber::PlaceMagnetAndCover(G4int copyID, G4LogicalVolume* expHallLog)
{
	...
	move.rotateZ(-Ang);
	fMagnetPhys = new G4PVPlacement(rotation, move, fMagnetLog,"CollectorMagnet",expHallLog,false,0,check);

	G4double MagCoverOffsetX = -(fPsClampThicknessInner-fPsClampThicknessOuter)/2;
	G4double MagCoverOffsetZ = -(fPsClampThicknessBottom-fPsClampThicknessTop)/2; 
	G4ThreeVector movecov(magnetPosX+MagCoverOffsetX, 0, magnetPosZ+MagCoverOffsetZ);
	movecov.rotateZ(-Ang);
	fMagnetCoverPhys = new G4PVPlacement(rotation, movecov, fMagnetCoverLog,"MagnetCovering",expHallLog,false,0,check);
	...
	movecmp.rotateZ(-Ang);
	fMclampChamberPhys = new G4PVPlacement(rotation, movecmp, fMclampChamberLog,"MagnetClampChamber", expHallLog,false,0,check);
...
void ApparatusSpiceTargetChamber::PlaceS3CableHolder(G4LogicalVolume* expHallLog)
{
	...
	fS3CasePhysical = new G4PVPlacement(sRotate, sTranslate, fS3CaseLogical, "s3CableCase", expHallLog, false, 0,check);
}
void ApparatusSpiceTargetChamber::PlaceConicalCollimator(G4LogicalVolume* expHallLog) {
	...
	fConicalCollimatorPhys = new G4PVPlacement(0,G4ThreeVector(0, 0, ZPosition),fConicalCollimatorLog,"ConicalCollimator",expHallLog,false,0,check);
