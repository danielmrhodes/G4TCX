...
ApparatusTigressStructure::ApparatusTigressStructure(G4bool check) :
	// LogicalVolumes
	fSquarePieceLog(0),
	fTrianglePieceLog(0),
	fRingPieceLog(0),
	fRodPieceLog(0)
{
	...
	/////////////////////////////////////////////////////////////////////
	// tigressCoords for TIGRESS
	// Note that the TIGRESS lampshade angles are rotated by 45 degrees with respect to those of TIGRESS.
	// Modified tigressCoords for TIGRESS are below!
	/////////////////////////////////////////////////////////////////////
	// theta
	fTigressCoords[0][0] 	= 45.0*deg;
	fTigressCoords[1][0] 	= 45.0*deg;
	fTigressCoords[2][0] 	= 45.0*deg;
	fTigressCoords[3][0] 	= 45.0*deg;
	fTigressCoords[4][0] 	= 90.0*deg;
	fTigressCoords[5][0] 	= 90.0*deg;
	fTigressCoords[6][0] 	= 90.0*deg;
	fTigressCoords[7][0] 	= 90.0*deg;
	fTigressCoords[8][0] 	= 90.0*deg;
	fTigressCoords[9][0] 	= 90.0*deg;
	fTigressCoords[10][0] 	= 90.0*deg;
	fTigressCoords[11][0] 	= 90.0*deg;
	fTigressCoords[12][0] 	= 135.0*deg;
	fTigressCoords[13][0] 	= 135.0*deg;
	fTigressCoords[14][0] 	= 135.0*deg;
	fTigressCoords[15][0] 	= 135.0*deg;
	// phi
	fTigressCoords[0][1] 	= 67.5*deg;
	fTigressCoords[1][1] 	= 157.5*deg;
	fTigressCoords[2][1] 	= 247.5*deg;
	fTigressCoords[3][1] 	= 337.5*deg;
	fTigressCoords[4][1] 	= 22.5*deg;
	fTigressCoords[5][1] 	= 67.5*deg;
	fTigressCoords[6][1] 	= 112.5*deg;
	fTigressCoords[7][1] 	= 157.5*deg;
	fTigressCoords[8][1] 	= 202.5*deg;
	fTigressCoords[9][1] 	= 247.5*deg;
	fTigressCoords[10][1] 	= 292.5*deg;
	fTigressCoords[11][1] 	= 337.5*deg;
	fTigressCoords[12][1] 	= 67.5*deg;
	fTigressCoords[13][1] 	= 157.5*deg;
	fTigressCoords[14][1] 	= 247.5*deg;
	fTigressCoords[15][1] 	= 337.5*deg;
	// yaw (alpha)
	fTigressCoords[0][2] 	= 0.0*deg;
	fTigressCoords[1][2] 	= 0.0*deg;
	fTigressCoords[2][2] 	= 0.0*deg;
	fTigressCoords[3][2] 	= 0.0*deg;
	fTigressCoords[4][2] 	= 0.0*deg;
	fTigressCoords[5][2] 	= 0.0*deg;
	fTigressCoords[6][2] 	= 0.0*deg;
	fTigressCoords[7][2] 	= 0.0*deg;
	fTigressCoords[8][2] 	= 0.0*deg;
	fTigressCoords[9][2] 	= 0.0*deg;
	fTigressCoords[10][2] 	= 0.0*deg;
	fTigressCoords[11][2] 	= 0.0*deg;
	fTigressCoords[12][2] 	= 0.0*deg;
	fTigressCoords[13][2] 	= 0.0*deg;
	fTigressCoords[14][2] 	= 0.0*deg;
	fTigressCoords[15][2] 	= 0.0*deg;
	// pitch (beta)
	fTigressCoords[0][3] 	= -45.0*deg;
	fTigressCoords[1][3] 	= -45.0*deg;
	fTigressCoords[2][3] 	= -45.0*deg;
	fTigressCoords[3][3] 	= -45.0*deg;
	fTigressCoords[4][3] 	= 0.0*deg;
	fTigressCoords[5][3] 	= 0.0*deg;
	fTigressCoords[6][3] 	= 0.0*deg;
	fTigressCoords[7][3] 	= 0.0*deg;
	fTigressCoords[8][3] 	= 0.0*deg;
	fTigressCoords[9][3] 	= 0.0*deg;
	fTigressCoords[10][3] 	= 0.0*deg;
	fTigressCoords[11][3] 	= 0.0*deg;
	fTigressCoords[12][3] 	= 45.0*deg;
	fTigressCoords[13][3] 	= 45.0*deg;
	fTigressCoords[14][3] 	= 45.0*deg;
	fTigressCoords[15][3] 	= 45.0*deg;
	// roll (gamma)
	fTigressCoords[0][4] 	= 67.5*deg;
	fTigressCoords[1][4] 	= 157.5*deg;
	fTigressCoords[2][4] 	= 247.5*deg;
	fTigressCoords[3][4] 	= 337.5*deg;
	fTigressCoords[4][4] 	= 22.5*deg;
	fTigressCoords[5][4] 	= 67.5*deg;
	fTigressCoords[6][4] 	= 112.5*deg;
	fTigressCoords[7][4] 	= 157.5*deg;
	fTigressCoords[8][4] 	= 202.5*deg;
	fTigressCoords[9][4] 	= 247.5*deg;
	fTigressCoords[10][4] 	= 292.5*deg;
	fTigressCoords[11][4] 	= 337.5*deg;
	fTigressCoords[12][4] 	= 67.5*deg;
	fTigressCoords[13][4] 	= 157.5*deg;
	fTigressCoords[14][4] 	= 247.5*deg;
	fTigressCoords[15][4] 	= 337.5*deg;
...
ApparatusTigressStructure::~ApparatusTigressStructure() {
...
G4int ApparatusTigressStructure::Build() { 
...
G4int ApparatusTigressStructure::Place(G4LogicalVolume* expHallLog, G4int selector) {
	...
	for(G4int i=iSquare1; i<=iSquare2; i++) { // loop over all square pieces
		alpha  = fTigressCoords[i][2]; // yaw
		beta   = fTigressCoords[i][3]; // pitch
		gamma  = fTigressCoords[i][4]; // roll
...
G4int ApparatusTigressStructure::BuildSquarePiece() {
...
G4int ApparatusTigressStructure::BuildTrianglePiece() {
	G4Material* material = G4Material::GetMaterial(fStructureMaterial);
	if(!material) {
		G4cout<<" ----> Material "<<fStructureMaterial<<" not found, cannot build the detector shell! "<<G4endl;
		return 0;
...
G4int ApparatusTigressStructure::BuildLargeRingFrame()
{
	G4Material* material = G4Material::GetMaterial(fStructureMaterial);
	if(!material) {
		G4cout<<" ----> Material "<<fStructureMaterial<<" not found, cannot build the detector shell! "<<G4endl;
...
G4int ApparatusTigressStructure::BuildRodPiece() {
...
G4SubtractionSolid* ApparatusTigressStructure::SquarePiece() {
	...
	G4Box* tigressStructureSquarePlate = new G4Box("tigressStructureSquarePlate", halfLengthX, halfLengthY, halfLengthZ);
	...
	G4SubtractionSolid* tigressStructureSquarePlateCut1 = new G4SubtractionSolid("tigressStructureSquarePlateCut1", tigressStructureSquarePlate, cutBgo, rotateCut, moveCut);
	...
	G4SubtractionSolid* tigressStructureSquarePlateCut2 = new G4SubtractionSolid("tigressStructureSquarePlateCut2", tigressStructureSquarePlateCut1, cutBgo, rotateCut, moveCut);
	...
	G4SubtractionSolid* tigressStructureSquarePlateCut3 = new G4SubtractionSolid("tigressStructureSquarePlateCut3", tigressStructureSquarePlateCut2, cutBgo, rotateCut, moveCut);
	...
	G4SubtractionSolid* tigressStructureSquarePlateCut4 = new G4SubtractionSolid("tigressStructureSquarePlateCut4", tigressStructureSquarePlateCut3, cutBgo, rotateCut, moveCut);
	...
	// snip 1st edge
	G4SubtractionSolid* tigressStructureSquarePlateCut5 = new G4SubtractionSolid("tigressStructureSquarePlateCut5", tigressStructureSquarePlateCut4, cutSide, rotateCut, moveCut);
	...
	// snip next edge
	G4SubtractionSolid* tigressStructureSquarePlateCut6 = new G4SubtractionSolid("tigressStructureSquarePlateCut6", tigressStructureSquarePlateCut5, cutSide, rotateCut, moveCut);
	...
	// snip next edge
	G4SubtractionSolid* tigressStructureSquarePlateCut7 = new G4SubtractionSolid("tigressStructureSquarePlateCut7", tigressStructureSquarePlateCut6, cutSide, rotateCut, moveCut);
	...
	// snip last edge
	G4SubtractionSolid* tigressStructureSquarePlateCut8 = new G4SubtractionSolid("tigressStructureSquarePlateCut8", tigressStructureSquarePlateCut7, cutSide, rotateCut, moveCut);
	...
	G4SubtractionSolid* tigressStructureSquarePlateCut9 = new G4SubtractionSolid("tigressStructureSquarePlateCut9", tigressStructureSquarePlateCut8, rodHole, rotateCut, moveCut);

	// snip next hole
	moveCut = G4ThreeVector(-1.0*fSquareRodPositionFromCenterOfSquareFace,1.0*fSquareRodPositionFromCenterOfSquareFace,zPositionRod-zPositionSquare);
	rotateCut = new G4RotationMatrix;

	G4SubtractionSolid* tigressStructureSquarePlateCut10 = new G4SubtractionSolid("tigressStructureSquarePlateCut10", tigressStructureSquarePlateCut9, rodHole, rotateCut, moveCut);

	// snip next hole
	moveCut = G4ThreeVector(1.0*fSquareRodPositionFromCenterOfSquareFace,-1.0*fSquareRodPositionFromCenterOfSquareFace,zPositionRod-zPositionSquare);
	rotateCut = new G4RotationMatrix;

	G4SubtractionSolid* tigressStructureSquarePlateCut11 = new G4SubtractionSolid("tigressStructureSquarePlateCut11", tigressStructureSquarePlateCut10, rodHole, rotateCut, moveCut);

	// snip last hole
	moveCut = G4ThreeVector(-1.0*fSquareRodPositionFromCenterOfSquareFace,-1.0*fSquareRodPositionFromCenterOfSquareFace,zPositionRod-zPositionSquare);
	rotateCut = new G4RotationMatrix;

	G4SubtractionSolid* tigressStructureSquarePlateCut12 = new G4SubtractionSolid("tigressStructureSquarePlateCut12", tigressStructureSquarePlateCut11, rodHole, rotateCut, moveCut);
	...
	G4SubtractionSolid* tigressStructureSquarePlateCut13 = new G4SubtractionSolid("tigressStructureSquarePlateCut13", tigressStructureSquarePlateCut12, squareWithRoundedCorners, rotateCut, moveCut);

	return tigressStructureSquarePlateCut13;
}


G4SubtractionSolid* ApparatusTigressStructure::TrianglePiece()
{
	...
	G4Tubs* tigressStructureTrianglePlate = new G4Tubs("tigressStructureTrianglePlate", innerRadius, outerRadius, halfLengthZ, startPhi, endPhi);
	...
	G4SubtractionSolid* tigressStructureTrianglePlateCut1 = new G4SubtractionSolid("tigressStructureTrianglePlateCut1", tigressStructureTrianglePlate, truncatedThreeSidedCylinder, rotateCut, move);
	...
	// snip snip
	G4SubtractionSolid* tigressStructureTrianglePlateCut2 = new G4SubtractionSolid("tigressStructureTrianglePlateCut2", tigressStructureTrianglePlateCut1, cutSide, rotateCut, moveCut);
	...
	// snip snip
	G4SubtractionSolid* tigressStructureTrianglePlateCut3 = new G4SubtractionSolid("tigressStructureTrianglePlateCut3", tigressStructureTrianglePlateCut2, cutSide, rotateCut, moveCut);
	...
	// snip snip
	G4SubtractionSolid* tigressStructureTrianglePlateCut4 = new G4SubtractionSolid("tigressStructureTrianglePlateCut4", tigressStructureTrianglePlateCut3, cutSide, rotateCut, moveCut);

	return tigressStructureTrianglePlateCut4;
}

G4Tubs* ApparatusTigressStructure::LargeRingFrame()
{
	G4double startPhi = 0.0*deg;
	G4double endPhi = 360.0*deg;
...
G4Tubs* ApparatusTigressStructure::RodPiece()
{
	G4double startPhi = 0.0*deg;
	G4double endPhi = 360.0*deg;
...
G4SubtractionSolid* ApparatusTigressStructure::SquareWithRoundedCorners()
{
	...
	G4Box* tigressStructureSquarePlate1 = new G4Box("tigressStructureSquarePlate1", halfLengthX, halfLengthY, halfLengthX);
	...
	G4SubtractionSolid* tigressStructureSquarePlate2 = new G4SubtractionSolid("tigressStructureSquarePlate2", tigressStructureSquarePlate1, roundedCorner, rotate, move);
	...
	G4SubtractionSolid* tigressStructureSquarePlate3 = new G4SubtractionSolid("tigressStructureSquarePlate3", tigressStructureSquarePlate2, roundedCorner, rotate, move);
	...
	G4SubtractionSolid* tigressStructureSquarePlate4 = new G4SubtractionSolid("tigressStructureSquarePlate4", tigressStructureSquarePlate3, roundedCorner, rotate, move);
	...
	G4SubtractionSolid* tigressStructureSquarePlate5 = new G4SubtractionSolid("tigressStructureSquarePlate5", tigressStructureSquarePlate4, roundedCorner, rotate, move);

	return tigressStructureSquarePlate5;
}

G4SubtractionSolid* ApparatusTigressStructure::TruncatedThreeSidedCylinder()
{
	G4double startPhi = 0.0*deg;
	G4double endPhi = 360.0*deg;
